      ...
      <div className="flex w-full px-6">
        <div className="mx-auto w-full max-w-7xl border-x border-b border-white/20">
          <header className="flex flex-col items-center gap-4 border-b border-white/20 px-6 py-16 text-center">
            <p className="text-sm text-[#E07A5F]">Student Testimonials</p>
          ...
          <ul className="grid md:grid-cols-2">
            {testimonials.map((testimonial) => (
              ...
              >
                <Quote className="size-5 text-[#E07A5F]" aria-hidden />
          ...
          <div className="flex justify-center px-6 py-8">
            <Link
              href="/testimonials"
              className="group inline-flex items-center gap-2 rounded-xl border border-white/2 px-5 py-2.5 text-sm bg-linear-to-b from-gray-100 to-gray-200 text-black"
            >
